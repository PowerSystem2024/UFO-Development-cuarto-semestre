...
var require_cjs = __commonJS({
  "node_modules/@eslint/config-helpers/dist/cjs/index.cjs"(exports) {
    ...
    function findPluginConfig(config, pluginConfigName) {
      ...
      const message = directConfig || flatConfig ? `Plugin config "${configName}" in plugin "${userPluginNamespace}" is an eslintrc config and cannot be used in this context.` : `Plugin config "${configName}" not found in plugin "${userPluginNamespace}".`;
